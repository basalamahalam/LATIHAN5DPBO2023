// Saya Muhammad Alam Basalamah [2101677] mengerjakan LATIHANPRAKTIKUM yang ke 5 dalam mata kuliah DPBO
...
//    private ArrayList<Gender> listGender;
    ...
    public Menu() {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("21123", "Cahya Gumilang", "A", "Laki - Laki"));
        listMhs.add(new Mahasiswa("20123", "Nelly Joy", "B", "Perempuan"));
        listMhs.add(new Mahasiswa("22122", "Muhammad Satria", "C", "Laki - Laki"));
...
//        this.listGender = new ArrayList<>();
    ...
    public void deleteData() {
        ...
        if(value == 0){        // Remove Data from List
